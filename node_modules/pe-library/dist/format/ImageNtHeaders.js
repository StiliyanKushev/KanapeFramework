...
var ImageNtHeaders = /** @class */ (function (_super) {
    ...
    ImageNtHeaders.from = function (bin, offset) {
        ...
        if (magic === ImageOptionalHeader64_1.default.DEFAULT_MAGIC) {
            len += ImageOptionalHeader64_1.default.size;
        }
        else {
            len += ImageOptionalHeader_1.default.size;
        }
    ...
    ImageNtHeaders.prototype.is32bit = function () {
        return (this.view.getUint16(ImageFileHeader_1.default.size + 4, true) ===
    ...
    Object.defineProperty(ImageNtHeaders.prototype, "fileHeader", {
        get: function () {
            return ImageFileHeader_1.default.from(this.view.buffer, this.view.byteOffset + 4);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(ImageNtHeaders.prototype, "optionalHeader", {
        get: function () {
            ...
            if (magic === ImageOptionalHeader64_1.default.DEFAULT_MAGIC) {
                return ImageOptionalHeader64_1.default.from(this.view.buffer, this.view.byteOffset + off);
            }
            else {
                return ImageOptionalHeader_1.default.from(this.view.buffer, this.view.byteOffset + off);
            }
        },
        enumerable: false,
        configurable: true
