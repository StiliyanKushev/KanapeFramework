...
var DERObject_1 = require("./DERObject");
...
var SpcLink = /** @class */ (function () {
    ...
    SpcLink.prototype.toDER = function () {
        ...
        if (this.tag === 2) {
            // EXPLICIT
            return derUtil_1.makeDERTaggedData(this.tag, v);
        }
        else {
            // IMPLICIT
            v[0] = 0x80 + this.tag;
...
var SpcLinkUrl = /** @class */ (function (_super) {
    ...
    function SpcLinkUrl(url) {
        return _super.call(this, 0, new DERObject_1.RawDERObject(derUtil_1.makeDERIA5String(url))) || this;
    }
    return SpcLinkUrl;
}(SpcLink));
...
var SpcLinkFile = /** @class */ (function (_super) {
    ...
    function SpcLinkFile(file) {
        var _this = this;
        var v = derUtil_1.makeDERBMPString(file);
        // [0] IMPLICIT BMPSTRING
        v[0] = 0x80;
        _this = _super.call(this, 2, new DERObject_1.RawDERObject(v)) || this;
        return _this;
    }
    return SpcLinkFile;
}(SpcLink));
